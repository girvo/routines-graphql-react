...
export const resolveDaySectionSlotsAsNode: NodeLoader<
  'DaySectionSlots',
  ReturnType<typeof decodeDaySectionSlotsId>
> = async ({ dayOfWeek, section }, context) => {
  assertAuthenticated(context)
  return { dayOfWeek, section }
}

export const resolveDailyTaskInstanceAsNode: NodeLoader<
  'DailyTaskInstance',
  ReturnType<typeof decodeDailyTaskInstanceId>
