...
const documents: Documents = {
    ...
    "\n        query PaginatedTasksOne {\n          tasks(first: 10) {\n            edges {\n              node {\n                id\n              }\n            }\n            pageInfo {\n              hasNextPage\n              endCursor\n              startCursor\n            }\n          }\n        }\n      ": types.PaginatedTasksOneDocument,
    "\n        query PaginatedTasksTwo($after: String) {\n          tasks(first: 10, after: $after) {\n            edges {\n              node {\n                id\n              }\n            }\n            pageInfo {\n              hasNextPage\n              endCursor\n            }\n          }\n        }\n      ": types.PaginatedTasksTwoDocument,
    "\n        query PaginatedTasksThree($after: String) {\n          tasks(first: 10, after: $after) {\n            edges {\n              node {\n                __typename\n              }\n            }\n            pageInfo {\n              hasNextPage\n              endCursor\n            }\n          }\n        }\n      ": types.PaginatedTasksThreeDocument,
};
